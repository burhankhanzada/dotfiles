...
echo '3 - Set home as default location for new windows'
...
echo '8 - Disable warning before empty the trash'
defaults write com.apple.finder WarnOnEmptyTrash -bool false

echo '9 - Show hidden files'
defaults write com.apple.finder AppleShowAllFiles -bool true

echo '10 - Set keep folders on top when sorting by name'
defaults write com.apple.finder _FXSortFoldersFirst -bool true

echo '11 - Show file extensions'
...
echo '15 - Disable the “Are you sure you want to open this application?” dialog'
